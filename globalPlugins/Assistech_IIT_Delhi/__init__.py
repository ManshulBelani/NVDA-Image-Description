...
class addProxyDetailsDialog(wx.Dialog):
    def __init__(self, document):
		...
		self.config = configobj.ConfigObj(os.path.join(globalVars.appArgs.configPath, "addons\Assistech_IIT_Delhi\globalPlugins\Assistech_IIT_Delhi\%s" % self.filename))
